output "marketplace_role_assignments_id" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.id if v.id != null && length(v.id) > 0 }
}
output "marketplace_role_assignments_condition" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.condition if v.condition != null && length(v.condition) > 0 }
}
output "marketplace_role_assignments_condition_version" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.condition_version if v.condition_version != null && length(v.condition_version) > 0 }
}
output "marketplace_role_assignments_delegated_managed_identity_resource_id" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.delegated_managed_identity_resource_id if v.delegated_managed_identity_resource_id != null && length(v.delegated_managed_identity_resource_id) > 0 }
}
output "marketplace_role_assignments_description" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.description if v.description != null && length(v.description) > 0 }
}
output "marketplace_role_assignments_name" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.name if v.name != null && length(v.name) > 0 }
}
output "marketplace_role_assignments_principal_id" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.principal_id if v.principal_id != null && length(v.principal_id) > 0 }
}
output "marketplace_role_assignments_principal_type" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.principal_type if v.principal_type != null && length(v.principal_type) > 0 }
}
output "marketplace_role_assignments_role_definition_id" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.role_definition_id if v.role_definition_id != null && length(v.role_definition_id) > 0 }
}
output "marketplace_role_assignments_role_definition_name" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.role_definition_name if v.role_definition_name != null && length(v.role_definition_name) > 0 }
}
output "marketplace_role_assignments_skip_service_principal_aad_check" {
  ...
  value       = { for k, v in azurerm_marketplace_role_assignment.marketplace_role_assignments : k => v.skip_service_principal_aad_check if v.skip_service_principal_aad_check != null }
}
